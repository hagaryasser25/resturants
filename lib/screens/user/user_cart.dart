                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Text(
                                              'اسم المطعم: ${cartList[index].resturantName.toString()}',
                                              style: TextStyle(
                                                  fontSize: 17,
                                                  color: HexColor('#999999')),
                                            ),
                                            Text(
                                              'السعر : ${cartList[index].price.toString()}',
                                              style: TextStyle(
                                                  fontSize: 17,
                                                  color: HexColor('#999999')),
                                            ),
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  if (user != null) {
                                                    ...
                                                    await companyRef
                                                      ...
                                                      'resturantName':
                                                          '${cartList[index].resturantName.toString()}',
                                                      'userName':
